...
namespace Forum.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
			...
			if (!string.IsNullOrWhiteSpace(Input.AboutMe) && Input.AboutMe != user.AboutMe)
			{
            ...
            {
                var userImagesPath = "./wwwroot/userImages/";
                ...
                var fileName = $"{user.Id}_{DateTime.Now.Ticks}{Path.GetExtension(ProfilePicture.FileName)}"; //user id + datetime = uniktId
